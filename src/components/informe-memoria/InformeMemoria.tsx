...
export function InformeMemoria() {
  return (
    <div className="relative w-full min-h-[calc(100vh-4rem)] dark:bg-zinc-950">
      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-2 sm:px-4 md:px-6 pt-4 sm:pt-8 md:pt-12 pb-8 sm:pb-12">
        <div className="mb-5 sm:mb-8 px-1 sm:px-0">
